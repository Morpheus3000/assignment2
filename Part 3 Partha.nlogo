...
to setup-patches
  ...
  ;ask patches [ ask n-of (obs / 100 * width * height) and not (pxcor = 0) and not (pycor = 0) set pcolor black]
  repeat 100 [ask patch random-pxcor random-pycor [set pcolor black]]
